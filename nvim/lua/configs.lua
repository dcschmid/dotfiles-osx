...
k('n', '<C-g>', [[:Telescope git_files<CR>]], { noremap = true, silent = true })       -- open netrw (native file expolorer)
...
k("n", "<leader>xx", "<cmd>Trouble<cr>", { silent = true, noremap = true })
k("n", "<leader>xw", "<cmd>Trouble workspace_diagnostics<cr>", { silent = true, noremap = true })
k("n", "<leader>xd", "<cmd>Trouble document_diagnostics<cr>", {silent = true, noremap = true })
k("n", "<leader>xl", "<cmd>Trouble loclist<cr>", {silent = true, noremap = true })
k("n", "<leader>xq", "<cmd>Trouble quickfix<cr>", {silent = true, noremap = true })
k("n", "gR", "<cmd>Trouble lsp_references<cr>", {silent = true, noremap = true })
k("n", "gpr", "<cmd>lua require('goto-preview').goto_preview_references()<CR>", {silent = true, noremap = true })
